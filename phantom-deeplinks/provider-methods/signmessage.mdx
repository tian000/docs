...
> **Info:** The message to be signed must be passed as a base58-encoded string.

> **Info:** For more information on how to verify the signature of a message, please refer to [Encryption Resources](../encryption.md#encryption-resources).
