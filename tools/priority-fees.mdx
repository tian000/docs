...
$$
priority\_fees = compute\_budget \times compute\_unit\_price
$$

where,

$$
compute\_budget = number\_of\_instructions \times compute\_unit\_limit
$$
...
{% embed url="https://docs.solana.com/proposals/fee\_transaction\_priority" %}
...
{% embed url="https://docs.solana.com/transaction\_fees#prioritization-fee" %}
